...
public class UserController {
    ...
    @GetMapping("/{author}")
    public ResponseEntity<Page<Book>> booksByAuthor(@PathVariable String author, Pageable pageable) {
        return new ResponseEntity(iBookStoreService.findByAuthor(author, pageable), HttpStatus.OK);
    }

    @GetMapping("/sort-asc/price")
    public ResponseEntity<Page<Book>> booksInAscendingOrderByPrice(Pageable pageable) {
        return new ResponseEntity(iBookStoreService.getAllBookByPriceAsc(pageable), HttpStatus.OK);
    }

    @GetMapping("/sort-desc/price")
    public ResponseEntity<Page<Book>> booksInDescendingOrderByPrice(Pageable pageable) {
